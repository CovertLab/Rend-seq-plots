function z_step = compute_step_z_score(data,half_width,av_thresh,gap)
...
right_av = convolve(data,right_filter);
right_av_2 = convolve(data.^2,right_filter);
right_var = right_av_2-right_av.^2;

left_av = convolve(data,left_filter);
left_av_2 = convolve(data.^2,left_filter);
